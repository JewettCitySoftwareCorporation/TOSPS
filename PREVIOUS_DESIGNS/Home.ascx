...
<link href='http://fonts.googleapis.com/css?family=Lato:400,700|Alfa+Slab+One' rel='stylesheet' type='text/css'>
        ...
        <div class="header-top">
            <div class="social-links">
                <ul>
                    ...
                    <li class="twitter"><a href="https://twitter.com/bbruckner2003" target="_blank">Twitter</a></li>
                </ul>
            </div>
            <nav class="secondary-navigation">
                <ul>
                    ...
                    |
                    <li><a href="/Charity-donations">Charity donations</a></li>
                    |
...
<nav class="main-navigation">
    ...
    <!-- container -->
        ...
        <div class="content" >
            <div id="ContentPane" class="container" runat="server" width="100%">
...
<footer class="main-footer">
    <div class="container">
        ...
        <div class="column right width25 information">
            ...
            <a class="link-back" href="#">Website design Birmingham | designbp</a>
        </div></div>
</footer>
