...
#dnn_MenuPane { border-radius: 10px; color: #fff; }
.therapist-search #dnn_MenuPane { background-color: #18bd8f; }
#dnn_MenuPane .bg-grey { background-color: #1b3352 !important; }
...
.content aside .blue { color: #30aef0; }
...
<nav class="main-navigation">
    <div class="container">
        ...
        <div class="content">
            <div class="container">
                <aside id="MenuPane" runat="server" class="trans">
